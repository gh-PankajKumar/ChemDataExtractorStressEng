...
class YieldStrengthParser(QuantityModelTemplateParser):
    pass


class MultiYieldStrengthParser(MultiQuantityModelTemplateParser):
    @property
    def multi_entity_phrase_3d(self):
        # Phrases of type yield strength of CEM 1, CEM 2 and CEM 3 is Val 1, Val 2 and Val 3
        return Group(
            self.prefix
            + self.list_of_cems
            + OneOrMore(
